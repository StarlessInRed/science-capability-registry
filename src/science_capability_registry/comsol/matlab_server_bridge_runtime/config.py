"""Configuration loading for COMSOL C01."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "comsol_C01_matlab_server_bridge_runtime.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if errors:
        ...
        raise ValueError("Invalid COMSOL C01 config:\n" + "\n".join(messages))
    return config
