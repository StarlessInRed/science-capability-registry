"""Configuration loading for COMSOL C02."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "comsol_C02_model_construction_api_contract.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if errors:
        ...
        raise ValueError("Invalid COMSOL C02 config:\n" + "\n".join(messages))
    return config
