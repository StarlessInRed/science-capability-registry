"""Configuration loading for OpenFOAM C01."""
...
SCHEMA_PATH = (
    REPO_ROOT
    / "schemas"
    / "openfoam_C01_lid_driven_cavity_incompressible_laminar.schema.json"
)
...
def validate_case_config(
    ...
    return validate_mapping(config, load_schema(schema_path), "OpenFOAM C01")
