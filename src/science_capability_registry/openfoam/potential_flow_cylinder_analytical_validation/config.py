"""Configuration loading for OpenFOAM C02."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "openfoam_C02_potential_flow_cylinder_analytical_validation.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    return validate_mapping(config, load_schema(schema_path), "OpenFOAM C02")
