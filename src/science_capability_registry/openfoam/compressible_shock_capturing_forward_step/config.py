"""Configuration loading for OpenFOAM C08."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "openfoam_C08_compressible_shock_capturing_forward_step.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    return validate_mapping(config, load_schema(schema_path), "OpenFOAM C08")
