"""Command line entrypoint for OpenFOAM C03."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run or dry-run the OpenFOAM C03 backward-facing step RANS capability.")
    parser.add_argument("--config", required=True, help="Path to an OpenFOAM C03 YAML config.")
