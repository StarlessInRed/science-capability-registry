"""Configuration loading for OpenFOAM C03."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "openfoam_C03_backward_facing_step_rans_internal_flow.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    return validate_mapping(config, load_schema(schema_path), "OpenFOAM C03")
