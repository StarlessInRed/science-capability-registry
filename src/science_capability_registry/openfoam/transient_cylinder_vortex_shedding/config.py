"""Configuration loading for OpenFOAM C05."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "openfoam_C05_transient_cylinder_vortex_shedding.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    return validate_mapping(config, load_schema(schema_path), "OpenFOAM C05")
