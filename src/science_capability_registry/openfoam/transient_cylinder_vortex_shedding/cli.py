"""Command line entrypoint for OpenFOAM C05."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run or dry-run the OpenFOAM C05 transient cylinder vortex-shedding capability.")
    parser.add_argument("--config", required=True, help="Path to an OpenFOAM C05 YAML config.")
