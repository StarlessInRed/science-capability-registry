...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run or dry-run the OpenFOAM C04 motorBike external-aero capability.")
    parser.add_argument("--config", required=True, help="Path to an OpenFOAM C04 YAML config.")
