"""Configuration loading for OpenFOAM C06."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "openfoam_C06_dam_break_vof_free_surface.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    return validate_mapping(config, load_schema(schema_path), "OpenFOAM C06")
