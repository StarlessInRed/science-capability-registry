"""Command line entrypoint for OpenFOAM C06."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run or dry-run the OpenFOAM C06 dam-break VOF capability.")
    parser.add_argument("--config", required=True, help="Path to an OpenFOAM C06 YAML config.")
