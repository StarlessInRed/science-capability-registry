"""Configuration loading for OpenFOAM C07."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "openfoam_C07_conjugate_heat_transfer_cooling.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    return validate_mapping(config, load_schema(schema_path), "OpenFOAM C07")
