"""Configuration loading and schema validation for Cantera C02."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "cantera_C02_freely_propagating_premixed_flame.schema.json"
...
def validate_case_config(
    ...
    if errors:
        ...
        raise ValueError("Invalid Cantera C02 config:\n" + "\n".join(messages))
    return config
