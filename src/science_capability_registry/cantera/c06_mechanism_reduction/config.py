"""Configuration loading and schema validation for Cantera C06."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "cantera_C06_mechanism_reduction.schema.json"
...
def validate_case_config(
    ...
    if errors:
        ...
        raise ValueError("Invalid Cantera C06 config:\n" + "\n".join(messages))
    return config
