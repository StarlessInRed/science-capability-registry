"""Configuration loading and schema validation for Cantera C05."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "cantera_C05_reaction_path_analysis.schema.json"
...
def validate_case_config(
    ...
    if errors:
        ...
        raise ValueError("Invalid Cantera C05 config:\n" + "\n".join(messages))
    return config
