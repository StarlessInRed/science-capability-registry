"""Configuration loading and schema validation for Cantera C01."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "cantera_C01_constant_pressure_ignition.schema.json"
...
def validate_case_config(
    ...
    if errors:
        ...
        raise ValueError("Invalid Cantera C01 config:\n" + "\n".join(messages))
    return config
