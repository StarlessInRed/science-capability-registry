"""Configuration loading for Gmsh C02."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "gmsh_C02_boundary_physical_group_contract.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if errors:
        ...
        raise ValueError("Invalid Gmsh C02 config:\n" + "\n".join(messages))
    return config
