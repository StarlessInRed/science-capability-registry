"""Configuration loading for Gmsh C05."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "gmsh_C05_boundary_layer_size_field_meshing.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if errors:
        ...
        raise ValueError("Invalid Gmsh C05 config:\n" + "\n".join(messages))
    return config
