"""Configuration loading for Gmsh C03."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "gmsh_C03_mesh_refinement_quality_trend.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if errors:
        ...
        raise ValueError("Invalid Gmsh C03 config:\n" + "\n".join(messages))
    return config
