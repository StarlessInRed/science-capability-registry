"""Configuration loading for Fluent C03 mesh convergence trends."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "fluent_C03_mesh_convergence_trend.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if errors:
        ...
        raise ValueError("Invalid Fluent C03 config:\n" + "\n".join(messages))
    return config
