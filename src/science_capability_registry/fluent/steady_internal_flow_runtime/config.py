"""Configuration loading for Fluent C01."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "fluent_C01_steady_internal_flow_runtime.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if errors:
        ...
        raise ValueError("Invalid Fluent C01 config:\n" + "\n".join(messages))
    return config
