"""Configuration loading for Fluent C08 Workbench parameter integration."""
...
SCHEMA_PATH = REPO_ROOT / "schemas" / "fluent_C08_workbench_parameter_integration.schema.json"
...
def validate_case_config(config: dict[str, Any], schema_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if errors:
        ...
        raise ValueError("Invalid Fluent C08 config:\n" + "\n".join(messages))
    return config
