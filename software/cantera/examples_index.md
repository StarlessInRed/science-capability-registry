...
| C06 | Cantera official Python example: Mechanism reduction | mechanism reduction | combustion | `software/cantera/assets/C06_mechanism_reduction.yaml` | benchmark candidate | 详细机理到简化机理的筛选和误差评估，计划作为下一阶段 capability。 |
