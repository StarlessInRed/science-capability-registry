...
SCHEMA_PATH = Path("schemas/comsol_C02_model_construction_api_contract.schema.json")
...
def test_comsol_c02_schema_rejects_unknown_key() -> None:
...
def test_comsol_c02_config_uses_environment_boundary() -> None:
    config = _config()
